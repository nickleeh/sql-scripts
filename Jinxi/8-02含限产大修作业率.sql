...
FROM
  ...
  (SELECT
       date(parameter_reading_time) reading_date
     , sum(parameter_reading_value) asset_failure_time
   FROM
     (SELECT
        location_lft
        , location_rgt
  ...
  (SELECT
       date(parameter_reading_time) reading_date
     , sum(parameter_reading_value) planned_downtime
   FROM
     (SELECT
        location_lft
        , location_rgt
  ...
  (SELECT
       date(parameter_reading_time) reading_date
     , sum(parameter_reading_value) tech_failure
   FROM (SELECT
           location_lft
           , location_rgt
         FROM asset_location
  ...
  (SELECT
       date(parameter_reading_time) reading_date
     , sum(parameter_reading_value) total_downtime
   FROM (SELECT
           location_lft
           , location_rgt
         FROM asset_location
  ...
  (SELECT
       date(parameter_reading_time) reading_date
     , sum(parameter_reading_value) accessment_rate
   FROM (SELECT
           location_lft
           , location_rgt
         FROM asset_location
  ...
  (SELECT
       date(parameter_reading_time) reading_date
     , sum(parameter_reading_value) mec_downtime
   FROM (SELECT
           location_lft
           , location_rgt
         FROM asset_location
  ...
  (SELECT
       date(parameter_reading_time) reading_date
     , sum(parameter_reading_value) ele_downtime
   FROM (SELECT
           location_lft
           , location_rgt
         FROM asset_location
  ...
  (SELECT
       date(parameter_reading_time) reading_date
     , sum(parameter_reading_value) automation_downtime
   FROM (SELECT
           location_lft
           , location_rgt
         FROM asset_location
  ...
  (SELECT
       date(parameter_reading_time) reading_date
     , sum(parameter_reading_value) repair_downtime
   FROM (SELECT
           location_lft
           , location_rgt
         FROM asset_location
  ...
  (SELECT
       date(parameter_reading_time) reading_date
     , sum(parameter_reading_value) planned_maintenance_downtime
   FROM (SELECT
           location_lft
           , location_rgt
         FROM asset_location
  ...
  (SELECT
       date(parameter_reading_time) reading_date
     , sum(parameter_reading_value) outside_downtime
   FROM (SELECT
           location_lft
           , location_rgt
         FROM asset_location
